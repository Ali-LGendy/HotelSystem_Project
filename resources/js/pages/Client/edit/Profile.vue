...
import SettingsLayout from '@/pages/Client/edit/Layout.vue';
...
<template>
    <div class="lg:ps-36 lg:pt-4 md:ps-16 md:pt-4 sm:ps-8 sm:pt-2">
            ...
            <div class="flex flex-col space-y-6">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <Input 
                        ...
                        name="avatar_img" 
                        :tabindex="1" 
                        @change="form.avatar_img = $event.target.files[0]" 
                    />
