  ...
  <div class="mx-auto max-w-7xl px-4 py-8">
    <div class="rounded-lg bg-gray-900 p-8 text-gray-200 shadow-lg">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                v-model="form.name"
                type="text"
                class="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-gray-200 focus:border-indigo-500 focus:ring-indigo-500"
                required
              />
      ...
      <div v-if="client.reservations && client.reservations.length > 0" class="mt-8">
        <h3 class="text-xl font-semibold mb-4 text-gray-100">Client Reservations</h3>
