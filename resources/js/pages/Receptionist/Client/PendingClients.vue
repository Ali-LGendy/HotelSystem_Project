                ...
                <table class="min-w-full divide-y divide-gray-700">
                    <thead class="bg-gray-800">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-300">Mobile</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-300">Country</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-300">Gender</th>
        ...
        <div class="rounded-lg bg-gray-900 p-8 text-gray-200 shadow-lg">
            ...
            <div class="mb-8 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <button @click="goBack" class="rounded-lg bg-blue-600 px-4 py-2 font-semibold text-white transition hover:bg-blue-700">
                ...
                >
                    ...
                    <template #cell-actions="{ row }">
                        <div class="flex items-center gap-2">
                            <Button variant="success" size="sm" @click="approveClient(row)" class="bg-green-600 text-white hover:bg-green-700">
                                Approve Client
                            </Button>
                            <Button variant="destructive" size="sm" @click="confirmRejectClient(row)" class="bg-red-600 text-white hover:bg-red-700">
                                Reject Client
                            </Button>
                        </div>
                    </template>
...
const handlePageChange = (pageIndex) => {
    router.visit(route('receptionist.clients.index', { page: pageIndex + 1 }), {
        only: ['pendingClients'],
        preserveState: true,
        preserveScroll: true,
    });
