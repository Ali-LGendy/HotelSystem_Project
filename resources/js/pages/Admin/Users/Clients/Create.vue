<template>
    <div class="mx-auto max-w-2xl rounded-lg bg-white p-8 shadow-lg">
        <h2 class="mb-6 text-2xl font-semibold">Create New Client</h2>
...
export default {
    ...
    setup() {
        ...
        const submitForm = () => {
            form.post(route('admin.users.clients.store'), {
                onSuccess: () => router.visit(route('admin.users.clients.index')),
            });
        };
