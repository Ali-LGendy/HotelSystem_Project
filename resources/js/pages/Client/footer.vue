...
<template>
  <footer class="border-t bg-white dark:bg-black">
      ...
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div class="space-y-6">
          ...
          <p class="text-sm text-muted-foreground max-w-xs">
            Experience unparalleled luxury and comfort in our premium accommodations, where every stay becomes an unforgettable journey.
          </p>
        ...
        <div class="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-2">
          <div class="space-y-6">
            ...
            <ul class="space-y-3">
              <li v-for="link in footerLinks.services" :key="link.label">
                <Link :href="link.href" class="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  {{ link.label }}
                </Link>
              </li>
            </ul>
          ...
          <div class="space-y-6">
            <h3 class="text-sm font-semibold">Stay Connected</h3>
            <div class="space-y-4">
              <p class="text-sm text-muted-foreground">Subscribe for exclusive offers and updates</p>
              <div class="space-y-2">
