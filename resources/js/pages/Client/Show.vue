    ...
    <div class="flex min-h-screen items-center justify-center bg-background p-8 text-foreground">
        <div class="w-full max-w-3xl">
            <Card class="w-full p-6">
                <CardHeader>
                    <CardTitle class="text-3xl font-bold">Client Details</CardTitle>
                </CardHeader>
                    ...
                    <div class="mt-6 grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <p
                                ...
                                :class="!user.data.is_approved ? 'bg-red-500 text-white' : 'bg-green-500 text-white'"
                            >
                                {{ user.data.is_approved ? 'Approved' : 'Not Approved' }}
                            </p>
                        </div>
